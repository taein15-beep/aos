...
export function SellerApplyForm() {
  ...
  const handleSubmit = () => {
    ...
    if (hasSellerApplyErrors(nextErrors)) {
      setErrors(nextErrors);
      setSubmitBanner("입력·동의 항목을 확인해 주세요.");
            ...
            <>
              <section className="seller-apply-section" aria-labelledby="seller-info-title">
                ...
                <div className="seller-apply-fields">
                  {isBusiness ? (
                    <>
                      <div className="full seller-apply-trio">
                    ...
                    <>
                      ...
                      <div className="full seller-apply-address-row">
                        <label className={errors.address ? "is-invalid" : undefined}>
                          <FieldLabel required htmlFor="address">
                            활동 주소
                          </FieldLabel>
                        ...
                        <div className="seller-address-search">
                          <span className="seller-field-label" aria-hidden="true">
                            &nbsp;
                          </span>
                          <button
                            type="button"
                    ...
                    <>
                      ...
                      <label className={errors.contactName ? "is-invalid" : undefined}>
                        ...
                        <input
                          ...
                          readOnly={form.representativeIsContact}
                          onChange={(event) => {
                            if (form.representativeIsContact) {
                              setForm((current) => ({
                                ...current,
              ...
              <section className="seller-apply-section" aria-labelledby="seller-referral-title">
                <header className="seller-apply-section-head">
                  <h3 id="seller-referral-title">추천인코드</h3>
                  <p>가입 승인 후 등록한 휴대전화번호가 판매점 추천인코드로 사용됩니다.</p>
                </header>
                <div className="seller-apply-fields">
                  <label className="full seller-check-inline">
                    <input
