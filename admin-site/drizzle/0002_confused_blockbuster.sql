...
SELECT `id`,`participant_id`,`reward_id`,`achieved_spot_count_at_application`,'DELIVERY',`status`,`recipient_name_encrypted`,`phone_encrypted`,`postal_code_encrypted`,`address_encrypted`,`address_detail_encrypted`,`applied_at`,`applied_at`,`applied_at`,`privacy_expires_at`,`applied_at`,`updated_at` FROM `reward_applications`;--> statement-breakpoint
DROP TABLE `reward_applications`;--> statement-breakpoint
ALTER TABLE `__new_reward_applications` RENAME TO `reward_applications`;--> statement-breakpoint
...
ALTER TABLE `tier_rewards` ADD `image_url` text;--> statement-breakpoint
ALTER TABLE `tier_rewards` ADD `application_starts_at` text;--> statement-breakpoint
ALTER TABLE `tier_rewards` ADD `application_ends_at` text;--> statement-breakpoint
ALTER TABLE `tier_rewards` ADD `fulfillment_methods` text DEFAULT 'DELIVERY,PICKUP' NOT NULL;--> statement-breakpoint
