...
const actionCopy:Record<ActionKey,[string,string,string]>={
  "정보 수정":["참여자 정보 수정 확인","샘플 사용자 참여자의 기본정보 수정 화면을 시연합니다.","변경 내용과 처리 사유는 관리자 활동 이력에 기록됩니다."],
