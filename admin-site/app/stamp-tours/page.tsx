...
import { CalendarDays, ChevronDown, Eye, MoreHorizontal, Pencil, Plus, QrCode, RotateCcw, Search, Users, Trophy, MapPinned, CirclePlay, Clock3, CircleStop } from "lucide-react";
...
export default function StampTourListPage() {
  ...
  const [moreOpen,setMoreOpen] = useState<number|null>(null); const [profileOpen,setProfileOpen] = useState(false); const [noticeOpen,setNoticeOpen] = useState(false);
  const pageSize = 5;
