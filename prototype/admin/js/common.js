...
(function () {
  ...
  window.AdminAssets.lockDesktopViewport = function () {
    if (!document.querySelector('.app')) return;

    var desktopWidth = 1600;
    ...
    viewport.setAttribute(
      'content',
      'width=' + desktopWidth + ', user-scalable=yes'
    );
    ...
    Array.prototype.forEach.call(document.styleSheets, function (sheet) {
      ...
      Array.prototype.forEach.call(rules || [], function (rule) {
        if (
          ...
          /max-width\s*:/i.test(rule.conditionText || '')
        ) {
          rule.media.mediaText =
            '(min-width: ' + desktopWidth + 'px) and (' + rule.conditionText + ')';
        }
      });
    });
  };

  window.AdminAssets.lockDesktopViewport();
  ...
  if (window.AdminAssets.sidebarHtml.indexOf('href="reservation_calendar.html"') === -1) {
    window.AdminAssets.sidebarHtml = window.AdminAssets.sidebarHtml.replace(
      '<a href="reservation_status.html">예약현황</a>',
      '<a href="reservation_status.html">예약현황</a>\r\n        <a href="reservation_calendar.html">예약달력</a>'
    );
  }
  ...
  window.AdminAssets.markSidebarActive = function (container) {
    ...
    var activePageMap = {
      ...
      'payment_setting.html': 'site_setting.html'
    };
